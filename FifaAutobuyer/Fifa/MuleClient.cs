...
namespace FifaAutobuyer.Fifa
{
    public class MuleClient
    {
        ...
        {
            var logData = new FUTNotification("Muling " + DestinationFUTClient.FUTAccount.EMail, data);
            FUTLogsDatabase.InsertFUTNotification(logData);
        }
        ...
        private async void MuleLogic()
        {
            ...
            {
                AddNotification(DestinationFUTClient.FUTAccount.EMail + "No destination account!");
            ...
            while(!loggedIn.Item1)
            {
                if(_stopMuling)
                {
                    AddNotification(DestinationFUTClient.FUTAccount.EMail + " Muling manually stopped!");
                ...
                {
                    AddNotification(DestinationFUTClient.FUTAccount.EMail + " Transfermarket is not enabled! Muling stopped!");
                ...
                if(currentTry == 3)
                {
                    AddNotification(DestinationFUTClient.FUTAccount.EMail + " Login failed 3 times! Muling stopped!");
            ...
            {
                AddNotification(CoinsOnDestinationAccount + " Credits! Muling stopped! Muling stopped!");
            ...
            AddNotification(CoinsOnDestinationAccount + " Muling finished!");
