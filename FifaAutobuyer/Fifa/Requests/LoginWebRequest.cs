...
{
    public class LoginWebRequest : FUTRequestBase, IFUTRequest<LoginResponse>
    {
        ...
        public async Task<LoginResponse> PerformRequestAsync()
        {
            try
            {
                ...
                var twoFactorCode = "";
                if (loggedInString.Contains("oneTimeCode") || loggedInString.Contains("tfa-codeSent-text"))
                {
        ...
        {
            var stringContent = new StringContent("{\"isReadOnly\":false,\"sku\":\"" + FUTAccount.FUTPlatform.SKU + "\",\"clientVersion\":1,\"locale\":\"de-DE\",\"method\":\"authcode\",\"priorityLevel\":4,\"identification\":{\"authCode\":\"" + authCode + "\",\"redirectUrl\":\"nucleus:rest\"},\"nucleusPersonaId\":" + personaID + ",\"gameSku\":\"" + FUTAccount.FUTPlatform.GameSKU +  "\"}");
